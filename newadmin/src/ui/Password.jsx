  ...
  return (
    <div className="main">
        ...
        <div className="input mt-2 relative">
            <input className="w-full outline-none border md:py-3 md:px-4 xxs:py-1 xxs:px-2 rounded-lg xxs:placeholder:text-xs md:placeholder:text-base" type={password ? "text" : "password"} placeholder={placeholder} />
